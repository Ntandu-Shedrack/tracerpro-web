    ...
    <header className="sticky top-0 backdrop-blur-sm z-20">
      ...
      <div className="w-full bg-black text-white py-2 px-3 text-sm flex items-center justify-center gap-2">
        ...
        <div className="flex items-center gap-1">
          <a href="/sign-up" className="hover:text-white/70 transition">Get Started for Free</a>
      ...
      <div className="py-5">
        ...
        <div className="flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-6 text-sm text-gray-600">
            ...
            <a href="/help" className="hover:text-black transition">Help</a>
            <a href="/sign-up" className="bg-black text-white px-4 py-2 rounded-md hover:bg-gray-800 transition font-medium">
              Get Started
            </a>
          </nav>
